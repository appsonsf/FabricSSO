...
export default class EditMobile extends Component {
    ...
    render() {
        return (
            <div className="modal fade editMobile" id="bindUserModal" role="dialog" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <button type="button" className="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                            </button>
                            <h4 className="modal-title">修改用户{this.props.data === null ? "" : this.props.data.name}手机号:</h4>
                        </div>
                        <div className="modal-body">
                            <form data-parsley-validate="" className="form-horizontal form-label-left">
                                <input type="hidden" ref="id" />
                                <div className="form-group">
                                    <label className="control-label col-md-3 col-sm-3 col-xs-12">手机号：
                                    </label>
                                    <div className="col-md-9 col-sm-9 col-xs-12">
                                        <input type="text" id="mobiles" className="form-control col-md-7 col-xs-12" />
                                    </div>
                                </div>
